...
public interface UsersService {
     ...
     *
     * @param usersInstance Details of the Users to be created; value cannot be null.
     * @return The newly created Users.
     */
    Users create(@Valid Users usersInstance);
    ...
    /**
     * Updates the details of an existing Users. It replaces all fields of the existing Users with the given usersInstance.
     *
     * This method overrides the input field values using Server side or database managed properties defined on Users if any.
     *
     * @param usersInstance The details of the Users to be updated; value cannot be null.
     * @return The updated Users.
     * @throws EntityNotFoundException if no Users is found with given input.
     */
    Users update(@Valid Users usersInstance);
     ...
     *
     * @param usersInstance The instance of the Users to be deleted; value cannot be null.
     */
    void delete(Users usersInstance);
     ...
     *
     * @param users value of users; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<SalaryDetails> findAssociatedSalaryDetailses(Integer users, Pageable pageable);

    /*
     * Returns the associated services for given Users id.
     *
     * @param users value of users; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Service> findAssociatedServices(Integer users, Pageable pageable);
     ...
     * @see Page
     */
    Page<UserDetails> findAssociatedUserDetailses(Integer users, Pageable pageable);
