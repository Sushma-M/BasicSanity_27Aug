 ...
 * @see Orders
 */
@Service("TestingDB_SQL.OrdersService")
@Validated
public class OrdersServiceImpl implements OrdersService {
    ...
    @Autowired
    @Qualifier("TestingDB_SQL.OrdersDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestingDB_SQL for table Orders to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service TestingDB_SQL for table Orders to {} format", options.getExportType());
