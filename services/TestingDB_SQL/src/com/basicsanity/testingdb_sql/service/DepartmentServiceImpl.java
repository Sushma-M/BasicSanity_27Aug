...
import com.basicsanity.testingdb_sql.Department;
import com.basicsanity.testingdb_sql.Employee;
 ...
 * @see Department
 */
@Service("TestingDB_SQL.DepartmentService")
@Validated
public class DepartmentServiceImpl implements DepartmentService {
    ...
    @Lazy
    @Autowired
    @Qualifier("TestingDB_SQL.EmployeeService")
    private EmployeeService employeeService;

    @Autowired
    @Qualifier("TestingDB_SQL.DepartmentDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestingDB_SQL for table Department to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service TestingDB_SQL for table Department to {} format", options.getExportType());
