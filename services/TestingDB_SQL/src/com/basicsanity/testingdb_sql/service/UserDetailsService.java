...
public interface UserDetailsService {
     ...
     */
    UserDetails getById(String userdetailsId);
     ...
     * @return UserDetails associated with the given userdetailsId.
     */
    UserDetails findById(String userdetailsId);
     ...
     */
    List<UserDetails> findByMultipleIds(List<String> userdetailsIds, boolean orderedReturn);
     ...
     */
    UserDetails delete(String userdetailsId);
     ...
     *
     * @param userDataId value of userDataId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<JoiningDetails> findAssociatedJoiningDetailses(String userDataId, Pageable pageable);
     ...
     * @see Page
     */
    Page<SalaryDetails> findAssociatedSalaryDetailses(String userDataId, Pageable pageable);
