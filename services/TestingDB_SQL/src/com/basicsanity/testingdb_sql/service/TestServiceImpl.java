...
import com.basicsanity.testingdb_sql.Test;
 ...
 * @see Test
 */
@Service("TestingDB_SQL.TestService")
@Validated
public class TestServiceImpl implements TestService {
    ...
    @Autowired
    @Qualifier("TestingDB_SQL.TestDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestingDB_SQL for table Test to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service TestingDB_SQL for table Test to {} format", options.getExportType());
