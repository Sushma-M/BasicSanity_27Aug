...
import com.basicsanity.testingdb_sql.Table13;
 ...
 * @see Table13
 */
@Service("TestingDB_SQL.Table13Service")
@Validated
public class Table13ServiceImpl implements Table13Service {
    ...
    @Autowired
    @Qualifier("TestingDB_SQL.Table13Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestingDB_SQL for table Table13 to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service TestingDB_SQL for table Table13 to {} format", options.getExportType());
