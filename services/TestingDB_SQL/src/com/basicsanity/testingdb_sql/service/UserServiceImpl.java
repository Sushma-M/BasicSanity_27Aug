...
import com.basicsanity.testingdb_sql.User;
 ...
 * @see User
 */
@Service("TestingDB_SQL.UserService")
@Validated
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    @Qualifier("TestingDB_SQL.UserDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestingDB_SQL for table User to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service TestingDB_SQL for table User to {} format", options.getExportType());
