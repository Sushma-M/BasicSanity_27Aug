...
import com.basicsanity.testingdb_sql.AllTypes;
import com.basicsanity.testingdb_sql.service.AllTypesService;
...
public class AllTypesController {
    ...
    public AllTypes editAllTypes(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        AllTypes newAllTypes = WMMultipartUtils.toObject(multipartHttpServletRequest, AllTypes.class, "TestingDB_SQL");
