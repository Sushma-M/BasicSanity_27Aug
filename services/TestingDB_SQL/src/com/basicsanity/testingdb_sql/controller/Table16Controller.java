...
import com.basicsanity.testingdb_sql.service.Table16Service;
...
public class Table16Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table16 getTable16(@RequestParam("column2") Integer column2, @RequestParam("column3") String column3) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table16 editTable16(@RequestParam("column2") Integer column2, @RequestParam("column3") String column3, @RequestBody Table16 table16) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable16(@RequestParam("column2") Integer column2, @RequestParam("column3") String column3) {
    ...
    public Page<Table16> searchTable16sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Table16s list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Table16> findTable16s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Table16s list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTable16sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Table16.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> table16Service.export(exportOptions, pageable, outputStream));
