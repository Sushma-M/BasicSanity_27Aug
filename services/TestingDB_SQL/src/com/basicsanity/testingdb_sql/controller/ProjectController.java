...
import com.basicsanity.testingdb_sql.service.ProjectService;
 ...
 * @see Project
 */
@RestController("TestingDB_SQL.ProjectController")
@Api(value = "ProjectController", description = "Exposes APIs to work with Project resource.")
@RequestMapping("/TestingDB_SQL/Project")
public class ProjectController {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProjectController.class);

    @Autowired
	@Qualifier("TestingDB_SQL.ProjectService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Project editProject(@PathVariable("id") Integer id, @RequestBody Project project) {
        LOGGER.debug("Editing Project with id: {}" , project.getProjectId());
