...
import com.basicsanity.testingdb_sql.service.AllTypesTableService;
 ...
 * @see AllTypesTable
 */
@RestController("TestingDB_SQL.AllTypesTableController")
@Api(value = "AllTypesTableController", description = "Exposes APIs to work with AllTypesTable resource.")
@RequestMapping("/TestingDB_SQL/AllTypesTable")
public class AllTypesTableController {
    ...
    @Autowired
	@Qualifier("TestingDB_SQL.AllTypesTableService")
    ...
    public AllTypesTable createAllTypesTable(@RequestPart("wm_data_json") AllTypesTable allTypesTable, @RequestPart(value = "blobColumn", required = false) MultipartFile _blobColumn) {
		LOGGER.debug("Create AllTypesTable with information: {}" , allTypesTable);

    allTypesTable.setBlobColumn(WMMultipartUtils.toByteArray(_blobColumn));
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AllTypesTable getAllTypesTable(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AllTypesTable editAllTypesTable(@PathVariable("id") Integer id, @RequestBody AllTypesTable allTypesTable) {
        LOGGER.debug("Editing AllTypesTable with id: {}" , allTypesTable.getAllTypesId());

        allTypesTable.setAllTypesId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AllTypesTable editAllTypesTable(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        AllTypesTable newAllTypesTable = WMMultipartUtils.toObject(multipartHttpServletRequest, AllTypesTable.class, "TestingDB_SQL");
        newAllTypesTable.setAllTypesId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAllTypesTable(@PathVariable("id") Integer id) {
    ...
    public Page<AllTypesTable> searchAllTypesTablesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering AllTypesTables list by query filter:{}", (Object) queryFilters);
    ...
    public Page<AllTypesTable> findAllTypesTables(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering AllTypesTables list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportAllTypesTablesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = AllTypesTable.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> allTypesTableService.export(exportOptions, pageable, outputStream));
