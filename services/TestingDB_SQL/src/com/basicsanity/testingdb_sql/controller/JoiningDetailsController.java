...
import com.basicsanity.testingdb_sql.service.JoiningDetailsService;
 ...
 * @see JoiningDetails
 */
@RestController("TestingDB_SQL.JoiningDetailsController")
@Api(value = "JoiningDetailsController", description = "Exposes APIs to work with JoiningDetails resource.")
@RequestMapping("/TestingDB_SQL/JoiningDetails")
public class JoiningDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public JoiningDetails getJoiningDetails(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public JoiningDetails editJoiningDetails(@PathVariable("id") Integer id, @RequestBody JoiningDetails joiningDetails) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteJoiningDetails(@PathVariable("id") Integer id) {
    ...
    public Page<JoiningDetails> searchJoiningDetailsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering JoiningDetails list by query filter:{}", (Object) queryFilters);
    ...
    public Page<JoiningDetails> findJoiningDetails(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering JoiningDetails list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportJoiningDetailsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = JoiningDetails.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> joiningDetailsService.export(exportOptions, pageable, outputStream));
