...
import com.basicsanity.testingdb_sql.service.Table46Service;
...
public class Table46Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table46 getTable46(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table46 editTable46(@PathVariable("id") Integer id, @RequestBody Table46 table46) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable46(@PathVariable("id") Integer id) {
    ...
    public Page<Table46> searchTable46sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Table46s list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Table46> findTable46s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Table46s list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTable46sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Table46.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> table46Service.export(exportOptions, pageable, outputStream));
    ...
    @RequestMapping(value="/{id:.+}/table47s", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the table47s instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Table47> findAssociatedTable47s(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated table47s");
        return table46Service.findAssociatedTable47s(id, pageable);
    }
