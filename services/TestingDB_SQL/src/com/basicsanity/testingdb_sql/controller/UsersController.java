...
import com.basicsanity.testingdb_sql.service.UsersService;
 ...
 * @see Users
 */
@RestController("TestingDB_SQL.UsersController")
@Api(value = "UsersController", description = "Exposes APIs to work with Users resource.")
@RequestMapping("/TestingDB_SQL/Users")
public class UsersController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UsersController.class);

    @Autowired
	@Qualifier("TestingDB_SQL.UsersService")
    ...
    public Users createUsers(@RequestBody Users usersInstance) {
		LOGGER.debug("Create Users with information: {}" , usersInstance);

		usersInstance = usersService.create(usersInstance);
		LOGGER.debug("Created Users with information: {}" , usersInstance);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Users editUsers(@PathVariable("id") Integer id, @RequestBody Users usersInstance) {
        LOGGER.debug("Editing Users with id: {}" , usersInstance.getUsers());

        usersInstance.setUsers(id);
        usersInstance = usersService.update(usersInstance);
        LOGGER.debug("Users details with id: {}" , usersInstance);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Service> findAssociatedServices(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated services");
        return usersService.findAssociatedServices(id, pageable);
    }
