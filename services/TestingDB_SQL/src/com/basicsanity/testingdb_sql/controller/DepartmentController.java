...
import com.basicsanity.testingdb_sql.service.DepartmentService;
 ...
 * @see Department
 */
@RestController("TestingDB_SQL.DepartmentController")
@Api(value = "DepartmentController", description = "Exposes APIs to work with Department resource.")
@RequestMapping("/TestingDB_SQL/Department")
public class DepartmentController {

    private static final Logger LOGGER = LoggerFactory.getLogger(DepartmentController.class);

    @Autowired
	@Qualifier("TestingDB_SQL.DepartmentService")
