...
import com.basicsanity.testingdb_sql.service.UserService;
 ...
 * @see User
 */
@RestController("TestingDB_SQL.UserController")
@Api(value = "UserController", description = "Exposes APIs to work with User resource.")
@RequestMapping("/TestingDB_SQL/User")
public class UserController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserController.class);

    @Autowired
	@Qualifier("TestingDB_SQL.UserService")
