...
/**
 * CompositeO2mParent generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`Composite O2M parent`")
@IdClass(CompositeO2mParentId.class)
public class CompositeO2mParent implements Serializable {
